...
export const Sidebar = () => {
    ...
    const sidebarItems = [
            ...
            { icon: "mr-4 pl-3 text-2xl ri-notification-2-line", sectionName: "Notifications"},
    ...
    return (
        <div className="col-span-1 flex flex-col py-6 pl-20 h-screen">
            ...
            <div className="flex flex-col flex-grow justify-between gap-1 mt-6 ">
                ...
                <div className="flex">
                    <img src={twitterAvi} alt="" className="flex self-center h-10 mr-4 rounded-full" />
                    <div className="flex flex-col justify-around mr-14">
                        <span className="font-bold">{user.name}</span>
                        <span className="text-gray-500">{user.email}</span>
                    </div>
                    <button className="hover:bg-gray-100 rounded-full px-3"><i className="ri-more-fill flex items-center text-xl"></i></button>
                </div>
            </div>
        </div>
